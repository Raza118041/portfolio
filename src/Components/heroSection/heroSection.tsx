...
const HeroSection = () => {
    return (
        <div className='flex flex-col-reverse py-20 md:py-32 max-md:gap-10 md:flex-row justify-between px-16  items-center bg-black' id='home'>
            ...
            <div className='p-[3px] rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 inline-block lg:mr-20 rotate-[3deg]'>
