...
const Project = () => {
    const projects = [
        ...
        { name: "RubnGub", description: "RubnGub is an online store designed like an e-commerce platform, offering a wide range of high-quality organic foods. Users can conveniently browse and purchase natural, chemical-free products focused on health and wellness.", techStack: "Nextjs, JavaScript, Tailwind CSS, Nest.js, MongoDB", livePreview: `${'http://rubngub.com/'}` },
        { name: "CodeSprint", description: "CodeSprint is a software development company with a dedicated career portal where users can explore and apply for exciting job opportunities. The platform connects talented professionals with roles in tech, development, and innovation, streamlining the recruitment process.", techStack: "Nextjs, JavaScript, Tailwind CSS, Nest.js, MongoDB", livePreview: `${'https://codesprint.site/'}` },
        { name: "Job Finder", description: "Job Finder is a frontend website featuring fully static content. It serves as a clean and responsive interface for showcasing job listings without dynamic functionality.", techStack: "Nextjs, JavaScript, Tailwind CSS", livePreview: "Coming Soon" },
        { name: "Chat Bot", description: "Chatbot is an AI-powered tool similar to ChatGPT, specifically trained for a custom task using the Hugging Face API. It provides intelligent and context-aware responses tailored to meet specific user needs.", techStack: "Nextjs, JavaScript, Tailwind CSS, Hugging Face", livePreview: "Coming Soon" },
    ]
    return (
